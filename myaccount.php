...
protect_page();
include 'layout/overall/header_account.php';
...
if ($render_page) {
	...
	<div id="myaccount">
		...
		<p>Welcome to your account page, <strong><?php if ($config['ServerEngine'] !== 'OTHIRE') echo $user_data['name']; else echo $user_data['id']; ?>.</strong><br></center>
			<?php if ($config['ServerEngine'] !== 'OTHIRE') {
				if ($user_data['premdays'] != 0) {
					echo '<center><br><img src="layout/images/global/images/account-status_green.gif"><br><h3>You have ' .$user_data['premdays']. ' remaining premium account days.</h3></center>';
				} else {
					echo '<center><br><img src="layout/images/global/images/account-status_red.gif"><h3> You are free account.</h3></center>';
				}
			} else {
		...
		?><br>
		<center><a href="shop.php"><img src="layout/images/global/images/webshop1.png" 
  		  onMouseOver="this.src='layout/images/global/images/webshop2.png'" 
  		  onMouseOut="this.src='layout/images/global/images/webshop1.png'" 
		 ></img></a>&emsp;<a href="buypoints.php"><img src="layout/images/global/images/gettibiacoins1.png" 
  		  onMouseOver="this.src='layout/images/global/images/gettibiacoins2.png'" 
  		  onMouseOut="this.src='layout/images/global/images/gettibiacoins1.png'" 
		 ></img></a></center>
		 <br></div>
		<div class="BoxFrameHorizontal" style="background-image:url(layout/images/global/images/box-frame-horizontal.gif);"></div>
