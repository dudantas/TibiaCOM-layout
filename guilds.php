...
include 'layout/overall/header_guilds.php';
		...
		<?php
			if ($config['forum']['guildboard'] === true && $config['forum']['enabled'] === true) {
				...
				if ($forumExist === false) {
					...
					<form action="" method="post">
						<ul>
							<div>Create forum guild board:<br>
...
<center>
			...
			<form action="" method="post" enctype="multipart/form-data">
				<ul>
					<div>Upload guild logo [.gif images only, 100x100px size]:<br>
		...
		<form action="" method="post">
			<ul>
				<div>Invite Character to guild:<br>
					<input type="text" name="invite" placeholder="Character name">
					<input type="submit" value="Invite Character">
				</div>
			</ul>
		</form></center>
		<!-- Guild message of the day motd --><center>
		<form action="" method="post">
			<ul>
				<div>Change guild message:</div>
				<div>
		...
		<!-- FORMS TO CHANGE GUILD NICK --><center>
			<form action="" method="post">
				<ul>
					<div>
		...
		<?php if ($members > 1) { ?>
		<!-- FORMS TO PROMOTE CHARACTER--><center>
		<form action="" method="post">
			<ul>
				<div>
		...
		<!-- Remove member from guild --><center>
		<form action="" method="post">
			<ul>
				<div>
		...
		<!-- forms to change rank titles --><center>
		<form action="" method="post">
			<ul>
				<div><b>Change rank titles:</b><br>
					<?php
						$rank_count = 1;
						foreach ($ranks as $rank) {
		...
		<!-- forms to disband guild --><center>
		<form action="" method="post">
			<ul>
				<div><b>DELETE GUILD (All members must be offline):</b><br>
		...
		<?php if ($members > 1) { ?><center>
		<form action="" method="post">
			<ul>
				<div><b>Change Leadership with:</b><br>
		...
		<?php } ?>
		<?php if ($config['ServerEngine'] == 'TFS_02' || $config['ServerEngine'] == 'OTHIRE' || $config['ServerEngine'] == 'TFS_10' && $config['guildwar_enabled'] === true) { ?><center>
		<h2>Guild War Management:</h2>
		<form action="" method="post">
			<ul>
				<div>Invite guild to war:<br>
		...
		<table id="guildsTable" class="table table-striped table-hover"><tr class="yellow"><th>Aggressor</th><th>Information</th><th>Enemy</th></tr></center>
		<?php
		$i = 0;
