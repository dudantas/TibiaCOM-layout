...
logged_in_redirect();
include 'layout/overall/header_register.php';
...
?>
	<form action="" method="post">
		<ul>
			...
			?><br>
			<div><b>World Type:</b></div>
			<img src="layout/images/global/images/option_server_pvp_type_open.gif">
			<div><input type="radio" checked="checked"> <b>Open PvP</b></div>
			<br>
			<div><b>World Server:</b></div>
			<img src="layout/images/global/images/option_server_location_all.png">
			<div><input type="radio" checked="checked"> <b><?php echo $config['site_title']; ?></b></div>
			<div>
				<h2>Server Rules</h2>
