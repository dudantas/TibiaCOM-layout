...
<center>
				<table>
					<tbody>
						<tr>
							<td><img src="layout/images/global/content/headline-bracer-left.gif"></td>
							...
							<td><img src="layout/images/global/content/headline-bracer-right.gif"></td>
						</tr>
					</tbody>
				</table>
			</center>
			...
			<div class="TableContainer">
				<div class="CaptionContainer">
					<div class="CaptionInnerContainer">
						<span class="CaptionEdgeLeftTop" style="background-image:url(layout/images/global/content/box-frame-edge.gif);"></span>
						<span class="CaptionEdgeRightTop" style="background-image:url(layout/images/global/content/box-frame-edge.gif);"></span>
						<span class="CaptionBorderTop" style="background-image:url(layout/images/global/content/table-headline-border.gif);"></span>
						<span class="CaptionVerticalLeft" style="background-image:url(layout/images/global/content/box-frame-vertical.gif);"></span>
						<div class="Text">Account Status</div>
						<span class="CaptionVerticalRight" style="background-image:url(layout/images/global/content/box-frame-vertical.gif);"></span>
						<span class="CaptionBorderBottom" style="background-image:url(layout/images/global/content/table-headline-border.gif);"></span>
						<span class="CaptionEdgeLeftBottom" style="background-image:url(layout/images/global/content/box-frame-edge.gif);"></span>
						<span class="CaptionEdgeRightBottom" style="background-image:url(layout/images/global/content/box-frame-edge.gif);"></span>
					</div>
				</div>
											...
											<tr>
												<td>
													<div class="TableShadowContainerRightTop">
														<div class="TableShadowRightTop" style="background-image:url(layout/images/global/content/table-shadow-rt.gif);"></div>
													</div>
													<div class="TableContentAndRightShadow" style="background-image:url(layout/images/global/content/table-shadow-rm.gif);">
...
if ($config['server']['freePremium'] == "yes") {
	$main_content .= '
																		<td><img class="AccountStatusImage" src="layout/images/account/account-status_green.gif" alt="free account"></td>
...
$main_content .= '
																		<td>
																			<form action="?subtopic=accountmanagement&action=manage" method="post" style="padding:0px;margin:0px;">
																				<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton.gif)">
																					<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_over.gif);">
																						</div>
																						<input class="ButtonText" type="image" name="Manage Account" alt="Manage Account" src="layout/images/global/buttons/_sbutton_manageaccount.gif">
																					</div>
																				</div>
																			</form>';
$main_content .= '
																			<div style="font-size:1px;height:4px;"></div>
																				<form action="?subtopic=accountmanagement&action=donate" method="post" style="padding:0px;margin:0px;">
																					<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton_green.gif)">
																						<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_green_over.gif);"></div>
																							<input class="ButtonText" type="image" name="Get Coins" alt="Get Coins" src="layout/images/global/buttons/_sbutton_gettibiacoins.gif">
																						</div>
																					</div>
																				</form>';
if ($group_id_of_acc_logged >= $config['site']['access_admin_panel']) {
	$main_content .= '
																				...
																				<form action="?subtopic=adminpanel" method="post" style="padding:0px;margin:0px;">
																					<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton_green.gif)">
																						<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_green_over.gif);"></div>
																							<input class="ButtonText" type="image" name="Logout" alt="Logout" src="layout/images/global/buttons/_sbutton_painel.gif">
																						</div>
																					</div>
																				</form>';
}
...
$main_content .= '
																				...
																				<form action="?subtopic=accountmanagement&action=logout" method="post" style="padding:0px;margin:0px;">
																					<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton_red.gif)">
																						<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_red_over.gif);"></div>
																							<input class="ButtonText" type="image" name="Logout" alt="Logout" src="layout/images/global/buttons/_sbutton_logout.gif">
																						</div>
																					</div>
																				</form>';
$main_content .= '
														...
														<div class="TableShadowContainer">
															<div class="TableBottomShadow" style="background-image:url(layout/images/global/content/table-shadow-bm.gif);">
															<div class="TableBottomLeftShadow" style="background-image:url(layout/images/global/content/table-shadow-bl.gif);"></div>
															<div class="TableBottomRightShadow" style="background-image:url(layout/images/global/content/table-shadow-br.gif);"></div>
														</div>
														</div>';
...
$main_content .= '
														...
														<img class="PremiumFeatureImage1" src="layout/images/premiumfeatures/PremiumIcon-Stamina.png" alt="premium feature 1" style="margin:0px 5px"/>
														<div>50% XP boost for 2 hours every day</div></div>
														<div style="justify-content: center">
														<img class="PremiumFeatureImage1" src="layout/images/premiumfeatures/PremiumIcon-Death.png" alt="premium feature 1" style="margin:0px 5px"/>
														<div>lose 30% less on death with a promotion</div></div>
														<div style="justify-content: flex-end">
														<img class="PremiumFeatureImage1" src="layout/images/premiumfeatures/PremiumIcon-Travel.png" alt="premium feature 1" style="margin:0px 5px"/>
																	...
																	<td>
																		<div style="float: right; margin-top: 7px;">
																			<form action="?subtopic=ticket" method="post" style="padding:0px;margin:0px;">
																				<div class="MediumButtonBackground" style="background-image:url(layout/images/global/buttons/mediumbutton.gif)" onmouseover="MouseOverMediumButton(this);" onmouseout="MouseOutMediumButton(this);"><div class="MediumButtonOver" style="background-image: url(&quot;layout/images/global/buttons/mediumbutton-over.gif&quot;); visibility: hidden;" onmouseover="MouseOverMediumButton(this);" onmouseout="MouseOutMediumButton(this);"></div><input class="MediumButtonText" type="image" name="Open Ticket" alt="Open Ticket" src="layout/images/global/buttons/open_ticket.png"></div>
																			</form>
																		</div>
																		...
																		<img style="border:0px;" src="layout/images/global/content/info.gif"></span></a></span>
																		</span></span><br>
...
$main_content .= '
				...
				<div class="TableShadowRightTop" style="background-image:url(layout/images/global/content/table-shadow-rt.gif);" >
				</div></div><div class="TableContentAndRightShadow" style="background-image:url(layout/images/global/content/table-shadow-rm.gif);" >
				<div class="TableContentContainer" >
				<table class="TableContent" width="100%"  style="border:1px solid #faf0d7;" >
				<tr><td><div style="height: 55px;" ><div id="DowloadBox" style="position: relative; float:right;" >
				<a href="?subtopic=downloadclient" >
				<img style="width: 45px; height: 45px; border: 0px; margin-right: 10px;" src="layout/images/account/download_windows.gif" /></a>
				<br/>
				...
				<div class="TableBottomShadow" style="background-image:url(layout/images/global/content/table-shadow-bm.gif);" >
				<div class="TableBottomLeftShadow" style="background-image:url(layout/images/global/content/table-shadow-bl.gif);" >
				</div>
				<div class="TableBottomRightShadow" style="background-image:url(layout/images/global/content/table-shadow-br.gif);" ></div>
	...
	$main_content .= '
				<div class="SmallBox" >
					<div class="MessageContainer" >
						<div class="BoxFrameHorizontal" style="background-image:url(layout/images/global/content/box-frame-horizontal.gif);" /></div>
						<div class="BoxFrameEdgeLeftTop" style="background-image:url(layout/images/global/content/box-frame-edge.gif);" /></div>
						<div class="BoxFrameEdgeRightTop" style="background-image:url(layout/images/global/content/box-frame-edge.gif);" /></div>
						<div class="Message" >
							<div class="BoxFrameVerticalLeft" style="background-image:url(layout/images/global/content/box-frame-vertical.gif);" /></div>
							<div class="BoxFrameVerticalRight" style="background-image:url(layout/images/global/content/box-frame-vertical.gif);" /></div>
							<table class="HintBox" >
								<tr>
									<td>
											...
											<form action="?subtopic=accountmanagement&action=registeraccount" method="post" style="padding:0px;margin:0px;" >
												<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton.gif)" >
													<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" >
														...
														<input class="ButtonText" type="image" name="Register Account" alt="Register Account" src="layout/images/global/buttons/_sbutton_registeraccount.gif" >
													</div>
												</div>
											</form>
											<div style="font-size:1px;height:4px;" ></div>
						...
						<div class="BoxFrameHorizontal" style="background-image:url(layout/images/global/content/box-frame-horizontal.gif);" /></div>
							<div class="BoxFrameEdgeRightBottom" style="background-image:url(layout/images/global/content/box-frame-edge.gif);" /></div>
							<div class="BoxFrameEdgeLeftBottom" style="background-image:url(layout/images/global/content/box-frame-edge.gif);" /></div>
						</div>
					</div><br/>';
											...
											<div class="BoxButtons" >
												<form action="?subtopic=accountmanagement&action=paymentshistory" method="post" style="padding:0px;margin:0px;" >
													<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton.gif)" >
														<div onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" >
															<div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_over.gif);" ></div>
															<input class="ButtonText" type="image" name="Confirm Transfer" alt="Confirm Transfer" src="layout/images/global/buttons/_sbutton_confirm.gif" >
														</div>
													</div>
												</form>
												<div style="font-size:1px;height:4px;" ></div>
																	...
																	<tr>
																		...
																		<td align="right" style="padding-right:7px;width:100%;">
																			<form action="?subtopic=accountmanagement&action=createcharacter" method="post" style="padding:0px;margin:0px;">
																				...
																				<div class="BigButton" style="background-image:url(layout/images/global/buttons/sbutton.gif)">
																					<div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image:url(layout/images/global/buttons/sbutton_over.gif);"></div>
																						<input class="ButtonText" type="image" name="Create Character" alt="Create Character" src="layout/images/global/buttons/_sbutton_createcharacter.gif">
																					</div>
																				</div>
																			</form>
																		</td>
