...
include 'layout/overall/header_shop.php';
...
if ($loggedin === true) {
	if (!empty($_POST['buy']) && $_SESSION['shop_session'] == $_POST['session']) {
		if ($user_znote_data['points'] >= $buy['points']) {
			?><td>You have<strong><font color="green"> <?php echo (int)($user_znote_data['points'] - $buy['points']); ?> points</font></strong>. (<a href="buypoints.php">Buy points</a>).</td><?php
		} else {
			?><td>You have <strong><font color="green"><?php echo $user_znote_data['points']; ?> points</font></strong>. (<a href="buypoints.php">Buy points</a>).</td><?php
		}
	} else {
		?><td>You have <strong><font color="green"><?php echo $user_znote_data['points']; ?> points</font></strong>. (<a href="buypoints.php">Buy points</a>).</td><?php
	}
...
<div id="categoryNavigator">
							<nobr>[<a href="#cat_itemids">Items</a>]</nobr>
							<nobr>[<a href="#cat_premium">Premium</a>]</nobr>
							<nobr>[<a href="#cat_outfits">Outfits</a>]</nobr>
							<nobr>[<a href="#cat_mounts">Mounts</a>]</nobr>
							<nobr>[<a href="#cat_misc">Misc</a>]</nobr>  
</div>
